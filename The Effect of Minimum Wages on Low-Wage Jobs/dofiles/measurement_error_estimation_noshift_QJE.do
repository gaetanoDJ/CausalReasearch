...
save "${data}annual_percentiles_`vv'_MNWAOR_.dta", replace
}
*
...
use "${data}annual_percentiles_`vv'_MNWAOR_.dta", clear
...
save "${data}ML_results_pooled_`vv'_MNWAOR__fullypool_noshift.dta", replace


use "${data}ML_results_pooled_`vv'_MNWAOR__fullypool_noshift.dta", clear
